...
input_file_path = "gs://etl-proj-ash/raw/orders/*"  # Use a wildcard to handle multiple files
...
df = df.withColumn("item_count", col("item_count").cast("float"))
...
df.write \
    .format("bigquery") \
    .option("table", "etl-proj-433402.dataprocetl.orders") \
